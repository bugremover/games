...
class HardScreen5 extends StatefulWidget {
  @override
  _SpellingGamePageState createState() => _SpellingGamePageState();
}

class _SpellingGamePageState extends State<HardScreen5> {
  String correctWord = 'rose';
  List<String> scrambledLetters = ['s', 'e', 'o', 'r'];
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: Image.asset('../assets/rose.jpeg', height: 200),
          ),
          Text(
            'Arrange the letters:',
