...
class LevelOneScreen1 extends StatefulWidget {
  @override
  _LevelOneScreenState createState() => _LevelOneScreenState();
}

class _LevelOneScreenState extends State<LevelOneScreen1> {
  // Correct order of image names
  final List<String> correctOrder = ['1-1.jpg', '1-2.jpg', '1-3.jpg', '1-4.jpg'];

  // Random order for displaying at the top
  List<String> shuffledOrder = ['1-3.jpg', '1-1.jpg', '1-4.jpg', '1-2.jpg'];
